...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-12 sm:py-20 bg-white relative w-full overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 sm:space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full badge-organic text-xs font-bold uppercase tracking-wider">
            <Heart className="w-4 h-4 text-[#1B4D2E] shrink-0" />
            <span>Established 2017 in Shoolagiri, Hosur</span>
          </div>

          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-serif font-bold text-[#1B4D2E] tracking-tight leading-snug">
            9 Years of Uncompromised Organic Pureness
          </h2>

          <p className="text-sm sm:text-lg text-[#64748B] leading-relaxed max-w-prose mx-auto">
        ...
        <div className="mt-10 sm:mt-14 grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          <div className="bg-[#FAF7F2] rounded-2xl p-6 sm:p-8 border border-[#1B4D2E]/10 hover:shadow-lg transition-all">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#1B4D2E] text-[#E5A93C] flex items-center justify-center text-2xl font-bold mb-5 sm:mb-6">
              🐄
            </div>
            <h3 className="text-lg sm:text-xl font-serif font-bold text-[#1E293B] mb-2 sm:mb-3">
            ...
            <ul className="mt-4 space-y-2 text-xs font-semibold text-[#1B4D2E]">
              <li className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-[#1B4D2E] shrink-0" />
          ...
          <div className="bg-[#FAF7F2] rounded-2xl p-6 sm:p-8 border border-[#1B4D2E]/10 hover:shadow-lg transition-all">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#7A5230] text-[#FAF7F2] flex items-center justify-center text-2xl font-bold mb-5 sm:mb-6">
              🌱
            </div>
            <h3 className="text-lg sm:text-xl font-serif font-bold text-[#1E293B] mb-2 sm:mb-3">
            ...
            <ul className="mt-4 space-y-2 text-xs font-semibold text-[#7A5230]">
              <li className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-[#7A5230] shrink-0" />
          ...
          <div className="bg-[#FAF7F2] rounded-2xl p-6 sm:p-8 border border-[#1B4D2E]/10 hover:shadow-lg transition-all">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#E5A93C] text-[#4A3525] flex items-center justify-center text-2xl font-bold mb-5 sm:mb-6">
              🍯
            </div>
            <h3 className="text-lg sm:text-xl font-serif font-bold text-[#1E293B] mb-2 sm:mb-3">
        ...
        <div id="process" className="mt-16 sm:mt-24 text-center max-w-2xl mx-auto space-y-2.5">
          <span className="text-xs font-bold uppercase tracking-widest text-[#7A5230]">
            Our Farm-to-Table Guarantee
          </span>
          <h3 className="text-xl sm:text-3xl font-serif font-bold text-[#1B4D2E]">
        ...
        <div className="mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {PROCESS_STEPS.map((item) => {
            ...
            return (
              <div
                key={item.step}
                className="bg-[#FCFAF7] rounded-xl p-5 sm:p-6 border border-[#1B4D2E]/10 relative overflow-hidden group hover:border-[#1B4D2E]/40 transition-colors"
              >
                <div className="text-2xl sm:text-3xl font-serif font-black text-[#1B4D2E]/15 group-hover:text-[#1B4D2E]/30 transition-colors mb-3">
                  {item.step}
                </div>
                <div className="w-10 h-10 rounded-lg bg-[#E8F5E9] text-[#1B4D2E] flex items-center justify-center mb-3">
                  <IconComponent className="w-5 h-5" />
                </div>
                <h4 className="font-serif font-bold text-[#1E293B] text-base sm:text-lg mb-1.5">
                  {item.title}
                </h4>
