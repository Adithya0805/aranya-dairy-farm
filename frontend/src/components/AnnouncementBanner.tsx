...
export default function AnnouncementBanner({ onLearnMore }: AnnouncementBannerProps) {
  return (
    <section className="bg-[#2C3E2B] text-[#FCFAF7] py-8 sm:py-10 px-4 sm:px-6 lg:px-8 border-t border-b border-[#1B4D2E]/20">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-4 text-center md:text-left">
        ...
        <div className="space-y-1">
          ...
          {onLearnMore && (
            <button
              onClick={onLearnMore}
              className="text-xs uppercase font-sans tracking-widest text-[#D99B26] hover:underline font-semibold pt-1"
            >
