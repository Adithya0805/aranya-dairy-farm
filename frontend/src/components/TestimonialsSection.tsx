...
export default function TestimonialsSection() {
  ...
  return (
    <section id="reviews" className="py-12 sm:py-20 bg-[#FCFAF7] border-t border-[#1B4D2E]/10 w-full overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Header & Justdial Proof Banner */}
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8 bg-white p-6 sm:p-10 rounded-3xl border border-[#1B4D2E]/10 shadow-xs">
          <div className="space-y-3 text-center lg:text-left">
            ...
            <h2 className="text-2xl sm:text-4xl font-serif font-bold text-[#1B4D2E]">
          ...
          {/* Justdial Proof Card */}
          <div className="bg-[#FAF7F2] p-5 sm:p-6 rounded-2xl border border-[#E5A93C]/40 text-center shrink-0 w-full sm:w-auto min-w-0 sm:min-w-[280px] shadow-xs">
            ...
            <div className="text-2xl sm:text-3xl font-serif font-bold text-[#1E293B]">
              3.6 / 5.0
            </div>
        ...
        <div className="mt-10 sm:mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {REVIEWS.map((rev, idx) => (
            <div
              key={idx}
              className="bg-white rounded-2xl p-6 sm:p-7 border border-[#1B4D2E]/10 shadow-xs flex flex-col justify-between relative group hover:shadow-md transition-shadow"
            >
              <Quote className="w-7 h-7 sm:w-8 sm:h-8 text-[#1B4D2E]/15 mb-3 sm:mb-4" />
              ...
              <div className="mt-5 pt-4 border-t border-gray-100 flex items-center justify-between">
                <div>
                  <div className="text-xs sm:text-sm font-bold text-[#1B4D2E]">{rev.name}</div>
